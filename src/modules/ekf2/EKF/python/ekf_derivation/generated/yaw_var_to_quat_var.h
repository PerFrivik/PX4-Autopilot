 ...
 *
 * Symbolic function: yaw_var_to_quat_var
 *
 * Args:
 *     state: Matrix24_1
 *     yaw_var: Scalar
...
void YawVarToQuatVar(const matrix::Matrix<Scalar, 24, 1>& state, const Scalar yaw_var,
                     matrix::Matrix<Scalar, 4, 4>* const q_var = nullptr) {
  // Total ops: 136
  ...
  // Output terms (1)
  if (q_var != nullptr) {
    matrix::Matrix<Scalar, 4, 4>& _q_var = (*q_var);

    _q_var(0, 0) = -_tmp0 * (-_tmp0 * _tmp2 - _tmp13 + _tmp8) -
                   _tmp3 * (-_tmp18 * _tmp3 - _tmp19 + _tmp20) -
                   _tmp9 * (-_tmp14 * _tmp9 - _tmp16 + _tmp17);
    _q_var(1, 0) = -_tmp0 * _tmp23 - _tmp25 * _tmp9 - _tmp28 * _tmp3;
    _q_var(2, 0) = -_tmp0 * _tmp30 - _tmp3 * _tmp33 - _tmp32 * _tmp9;
    _q_var(3, 0) = -_tmp0 * _tmp34 - _tmp3 * _tmp37 - _tmp36 * state(2, 0);
    _q_var(0, 1) = 0;
    _q_var(1, 1) = -_tmp0 * _tmp25 + _tmp21 * _tmp28 + _tmp23 * _tmp9;
    _q_var(2, 1) = -_tmp0 * _tmp32 + _tmp21 * _tmp33 + _tmp30 * _tmp9;
    _q_var(3, 1) = -_tmp0 * _tmp35 + _tmp21 * _tmp37 + _tmp34 * _tmp9;
    _q_var(0, 2) = 0;
    _q_var(1, 2) = 0;
    _q_var(2, 2) = _tmp0 * _tmp33 + _tmp21 * _tmp32 - _tmp3 * _tmp30;
    _q_var(3, 2) = _tmp0 * _tmp37 + _tmp36 * state(0, 0) - _tmp38 * state(1, 0);
    _q_var(0, 3) = 0;
    _q_var(1, 3) = 0;
    _q_var(2, 3) = 0;
    _q_var(3, 3) = _tmp36 * state(1, 0) - _tmp37 * _tmp9 + _tmp38 * state(0, 0);
  }
